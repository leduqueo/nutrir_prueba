...
<div>
<h1 class="text-center">Registro Comedores</h1>
...
<fieldset>   
<legend class="text-center header text-success">Datos comedores</legend> 
...
<div class="form-group">
			...
			<input id="fechaI" name="fechI"  type="date"  class="form-control"  onchange="validarCampos()" required>
...
<div style="text-align: center;" class="form-group">
			...
			<div id= "etario" class="form-control"> </div>
...
<br>
<div style="text-align: center;" class="form-group">
<label for="visita">¿Requiere visita domiciliaria?</label>
<select name="visita" id="visita" class="form-control">
<option name="visita" id="visita" value="">Si</option>
<option name="visita" id="visita" value="">No</option>
<option name="visita" id="visita" value="">N/A</option>
</select>
</div>
<br>
<div style="text-align: center;" class="form-group">
<label for="exoneracion">¿Exoneración cuota de solidaridad?</label>
<select name="exoneracion" id="exoneracion" class="form-control">
<option name="exoneracion" id="exoneracion" value="">Si</option>
<option name="exoneracion" id="exoneracion" value="">No</option>
<option name="exoneracion" id="exoneracion" value="">N/A</option>
</select>
</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="contextfam">Contexto familiar</label>
<input type="text" id="contextfam" name="contextfam" class="form-control">

</div>
<br><div style="text-align: center;" class="form-group" > 
<label for="nombrequienapliq">Nombre de quien aplica caracterización</label>
<input type="text" id="nombrequienapliq" name="nombrequienapliq" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="cargoapliq">Cargo de quien aplica la caracterización</label>
<input type="text" id="lugarlabor" name="lugarlabor" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="fechegre">Fecha de egreso</label>
<input type="date" id="fechegre" name="fechegre" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="motivoegreso">Motivo de egreso</label>
<input type="text" id="motivoegreso" name="motivoegreso" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="observe">Observacion egreso</label>
<input type="text" id="observe" name="observe" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="fechreing">Fecha reingreso</label>
<input type="date" id="fechreing" name="fechreing" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="numreingr">Numero de reingreso</label>
<input type="date" id="numreingr" name="numreingr" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="numreingr">Numero de reingreso</label>
<input type="text" id="numreingr" name="numreingr" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="fechTrasl">fecha de traslado</label>
<input type="date" id="fechTrasl" name="fechTrasl" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group">

<label for="centrodeTrab">Centro de trabajo origen</label>
<select name="centrodeTrab" id="centrodeTrab" class="form-control">
 <option name="centrodeTrab" id="centrodeTrab" value="">Buena Vista</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Comuneros</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">El Carmen</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Guayabal</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Hogar Amigos</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Jaime Restrepo</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Juan XXIII</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">La Frontera</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">La Playita</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">La Victoria</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Marmato</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Nevado</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Pastoral Social</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Perpetuo Socorro</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">San Anibal</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">San Cayetano</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">San Martin</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">San Sebastian</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Santa Ana</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Solferino</option>
 <option name="centrodeTrab" id="centrodeTrab" value="">Villa del Carmen</option>
 </select>
</div>
<br>
<div style="text-align: center;" class="form-group">

<label for="centrodeTrabdest">Centro de trabajo destino</label>
<select name="centrodeTrabdest" id="centrodeTrabdest" class="form-control">
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Buena Vista</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Comuneros</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">El Carmen</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Guayabal</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Hogar Amigos</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Jaime Restrepo</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Juan XXIII</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">La Frontera</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">La Playita</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">La Victoria</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Marmato</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Nevado</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Pastoral Social</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Perpetuo Socorro</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">San Anibal</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">San Cayetano</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest"value="">San Martin</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">San Sebastian</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Santa Ana</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Solferino</option>
 <option name="centrodeTrabdest" id="centrodeTrabdest" value="">Villa del Carmen</option>
 </select>
</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="fechultiActa">fecha última acta de compromiso</label>
<input type="date" id="fechultiActa" name="fechultiActa" class="form-control">

</div>
<br>
<div style="text-align: center;" class="form-group" > 
<label for="numActa">Numero de actas</label>
<input type="text" id="numActa" name="numActa" class="form-control">
